(function($, document, window){
    ...
    EasyEditor.prototype.addToolbar = function(){
        ...
        $(_this.elem).before('<div class="'+ _this.className +'-toolbar"><ul id="selectable"></ul></div>');
    ...
    EasyEditor.prototype.injectButton = function(settings){
        ...
        if(settings.buttonHtml) {
            if(settings.childOf !== undefined) {
                ...
                $parentContainer.append('<li><button type="button" class="btn btnnopressed toolbar-'+ settings.buttonIdentifier +'" title="'+ buttonTitle +'">'+ settings.buttonHtml +'</button></li>');
            }
            else {
                _this.$toolbarContainer.children('ul').append('<li class="ui-widget-content"><button type="button" class="btn btnnopressed toolbar-'+ settings.buttonIdentifier +'" title="'+ buttonTitle +'">'+ settings.buttonHtml +'</button></li>');
            }
        }
